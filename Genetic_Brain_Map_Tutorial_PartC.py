...
#****For part 2 of loading in the data, this is the input data you made in Tutioral B. 
...
#*****here, change this to the name of the columns you want to (eventually) plot in freesurfer. I usually plot the Log of the P values and the genetic correlation
